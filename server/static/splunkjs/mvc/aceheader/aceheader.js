...
define('splunkjs/mvc/aceheader/aceheader',['require','exports','module','underscore','jquery','../mvc','../basesplunkview','helpers/AppNav','collections/services/data/ui/Navs','collections/services/data/ui/Views','collections/services/SavedSearches','splunk.config','./acemenubuilder','collections/services/AppLocals','splunk.config','splunk.util','css!./aceheader'],function (require, exports, module) {
		...
		render: function() {
			if (initialized) {
				this.$el.html(_.template(AceHeader.template, {
                    rootPath: splunkConfig.MRSPARKLE_ROOT_PATH + '/' + splunkConfig.LOCALE,
					navData: allMenuData,
	...
	// Class static
	{
		...
		<div> \
	        <ul class="splunk-account-bar-items"> \
			    <li> \
        			<a href="<%=rootPath%>/manager/<%= appNamespace %>/authentication/changepassword/admin?action=edit" class="splunk-user-full-name"><%- userName %></a> \
    			</li> \
			    ...
			    <li class="splunk-account-divider">|</li> \
		        <li> \
		            <a href="<%=rootPath%>/manager/<%= appNamespace %>">Manager</a> \
		        </li> \
		        <li class="splunk-account-divider">|</li> \
		        <li> \
		            <a href="<%=rootPath%>/alerts/<%= appNamespace %>" class="alerts_opener">Alerts</a> \
		        </li> \
		        <li class="splunk-account-divider">|</li> \
		        <li> \
		            <a href="<%=rootPath%>/app/<%= appNamespace %>/job_management" class="job_manager_opener">Jobs</a> \
		        </li> \
		        <li class="splunk-account-divider">|</li> \
		        <li> \
		            <a href="<%=rootPath%>/account/logout">Logout</a> \
		        </li> \
		    </ul> \
		    <div class="splunk-app-logo-container"> \
		    	<a href="<%=rootPath%>/app/<%= appNamespace %>" class="splunk-app-logo"></a> \
