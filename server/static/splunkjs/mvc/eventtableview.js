define(function(require, exports, module) {
    ...
    var DragDrop = require("jquery.ui.sortable");
    var Messages = require("./messages");
    var DropDown = require("bootstrap.dropdown");

    require("css!../css/eventtable.css");
...
<table class="table table-striped table-chrome event-list"> \
    ...
    var EventTableView = BaseSplunkView.extend(
        // Instance
        {
            moduleId: module.id,

            className: "splunk-eventtable",
            ...
            initialize: function(options) {
                ...
                this.bindToComponent(options.managerid, this.onManagerChange, this);
            },
            ...
            onManagerChange: function(managers, manager) {
                ...
                if (this.summaryData) {
                    this.summaryData.off(null, null, this);
                ...
                if (manager) {
                    ...
                    manager.on("search:done", this.onSearchProgress, this);
                }
            },
            ...
            render: function() {
                ...
                if (this.fetchedEvents.get("events").length > 0) {
                    ...
                    this.$el.html(_.template(EventTableView.template, {
            ...
            onSearchProgress: function(properties, job) {
                ...
                // for no reason
                if (properties.content.statusBuckets > 0 && this.summaryData) {
                    ...
                    this.summaryData.fetch({
                        success: function() {
                            var summary = that.summaryData.data();
                            that.fields.set(
                                "available",
                                _.difference(
                                    summary.fields ? _.keys(summary.fields) : [],
            ...
            onPerPageClicked: function(e) {
                ...
                this.eventsPerPage = parseInt(perPage, 10);
                this.goToOffset();
            },
